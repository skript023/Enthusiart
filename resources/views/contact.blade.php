...
<section class="py-5 contact-section" style="margin-top: 80px;">
    <div class="container">
        ...
        <div class="row d-flex align-items-center mb-3">
            <div class="card-about text-center justify-content-center align-items-center mb-3">
                <div class="card-body flex-1 text-center justify-content-center align-items-center">
                    ...
                    <p class="card-text text-center">info@enthusiart.com</p>
                </div>
            </div>
            <div class="card-about text-center justify-content-center align-items-center mb-3">
                <div class="card-body flex-1 text-center justify-content-center align-items-center">
                    <i class="fa-solid fa-phone fa-2xl" style="color: #364A99;"></i>
                    <p class="card-text text-center">(021) 12345678</p>
                </div>
            </div>
        </div>
        <div class="row d-flex align-items-center mb-3">
            <div class="card-about text-center justify-content-center align-items-center mt-3">
                <div class="card-body flex-1 text-center justify-content-center align-items-center">
                    <i class="fa-brands fa-square-x-twitter fa-2xl" style="color: #364A99;"></i>
                    <p class="card-text text-center">@enthusiart_id</p>
                </div>
            </div>
            <div class="card-about text-center justify-content-center align-items-center mt-3">
                <div class="card-body flex-1 text-center justify-content-center align-items-center">
            ...
            <div class="card-about text-center justify-content-center align-items-center mt-3">
                <div class="card-body flex-1 text-center justify-content-center align-items-center">
                    ...
                    <p class="card-text text-center">Enthusiart Gallery</p>
                </div>
            </div>
        </div>
    </div>
