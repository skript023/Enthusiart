            ...
            <div class="form-upload mt-4">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="upload-wrapper">
                        <input type="file" id="file" accept="image/*" required hidden>
                    ...
                    <div class="box d-flex justify-content-center">
                        <div class="container">
                            ...
                            <div class="form-group mb-3">
                                <label for="fullname" class="form-label">Artist Name</label>
                                <input type="text" class="form-control" name="fullname" id="fullname" value="{{ $fullname }}" readonly required>
                            </div>
                            <!-- Category -->
                            <div class="form-group mb-3">
                      ...
                      <div class="container">
                        <!-- Artwork Name -->
                        <div class="form-group mb-3">
                            <label for="artworks_name" class="form-label">Artwork Name</label>
                            <input type="text" class="form-control" name="artworks_name" id="artworks_name" placeholder="Give your artwork a name" required>
                        </div>
                        <!-- Year of Artwork -->
                        <div class="form-group mb-3">
                    ...
                    <div class="btn-wrapper d-flex justify-content-end">
                        <button type="submit" class="btn btn-upload">Publish</button>
                    </div>
                </form>
            </div>
        </div>
