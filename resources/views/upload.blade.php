    ...
    <div class="container">
        ...
        <div class="row border rounded-3 d-flex flex-column align-items-center mb-5" style="background-color: #F0F3FF;">
            <div class="form-upload mt-4">
                <form action="/artwork/upload" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- Upload Image -->
                    ...
                    <div class="box d-flex justify-content-center">
                      ...
                      <div class="container">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="artwork_name" id="artwork_name" placeholder="Give your artwork a name" required>
                        </div>
                        <!-- Year of Artwork -->
                        <div class="form-group mb-3">
